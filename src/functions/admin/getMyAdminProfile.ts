...
export const getMyAdminProfile = onCall<undefined, Promise<GetMyAdminProfileResponse>>({cors: true, region: 'us-central1', minInstances: 1, maxInstances: 10}, async (request) => {
